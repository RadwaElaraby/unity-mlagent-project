...
with open ('output/'+GAME11+'/comm_atoc_eval_stuck_collision_v3_binary_matrices_obs_3/testing_cumulative_rewards', 'rb') as fp:
    game11_testing_cumulative_rewards = pickle.load(fp)
with open ('output/'+GAME11+'/comm_atoc_eval_stuck_collision_v3_binary_matrices_obs_3/testing_collisions_over_training_steps', 'rb') as fp:
    game11_testing_collisions_over_training_steps = pickle.load(fp)
with open ('output/'+GAME11+'/comm_atoc_eval_stuck_collision_v3_binary_matrices_obs_3/testing_coordinations_over_training_steps', 'rb') as fp:
    game11_testing_coordinations_over_training_steps = pickle.load(fp)
with open ('output/'+GAME11+'/comm_atoc_eval_stuck_collision_v3_binary_matrices_obs_3/testing_episode_length_over_training_steps', 'rb') as fp:
    game11_testing_episode_length_over_training_steps = pickle.load(fp)
with open ('output/'+GAME11+'/comm_atoc_eval_stuck_collision_v3_binary_matrices_obs_3/testing_episode_steps_over_training_steps', 'rb') as fp:
    game11_testing_episode_steps_over_training_steps = pickle.load(fp)
with open ('output/'+GAME11+'/comm_atoc_eval_stuck_collision_v3_binary_matrices_obs_3/testing_goals_reached_over_training_steps', 'rb') as fp:
...
plt.subplot(2, 1, 1)
plt.plot(np.array(game6_testing_episode_steps_over_training_steps).mean(axis=1), 'c', label='latest 3 pos shared + backup cont.')
#plt.plot(np.array(game3_testing_episode_steps_over_training_steps).mean(axis=1), 'c--', label='latest obs shared', alpha=0.6)
...
plt.plot(np.array(game1_testing_episode_steps_over_training_steps).mean(axis=1), 'y--', label='baseline', alpha=0.6)
#plt.plot(np.array(game5_testing_episode_steps_over_training_steps).mean(axis=1), 'g', label='baseline with backup cont.')
plt.plot(np.array(game7_testing_episode_steps_over_training_steps).mean(axis=1), 'r', label='baseline + backup cont. 2')
plt.plot(np.array(game8_testing_episode_steps_over_training_steps).mean(axis=1), 'g', label='basline + CNN RMS + backup cont. 2')
#plt.plot(np.array(game9_testing_episode_steps_over_training_steps).mean(axis=1), 'b', label='basline + CNN (w ids) + backup cont. 2')
plt.plot(np.array(game10_testing_episode_steps_over_training_steps).mean(axis=1), '#831a1a', label='basline + CNN Adam + backup cont. 2')
plt.plot(np.array(game11_testing_episode_steps_over_training_steps).mean(axis=1), '#9c7722', label='basline + CNN Adam + backup cont. 3')
...
plt.subplot(2, 1, 2)
plt.plot(np.array(game6_testing_goals_reached_over_training_steps).mean(axis=1), 'c', label='latest 3 pos shared + backup cont.')
...
plt.plot(np.array(game8_testing_goals_reached_over_training_steps).mean(axis=1), 'g', label='basline + CNN RMS + backup cont. 2')
...
plt.plot(np.array(game10_testing_goals_reached_over_training_steps).mean(axis=1), '#831a1a', label='basline + CNN Adam + backup cont. 2')
plt.plot(np.array(game11_testing_goals_reached_over_training_steps).mean(axis=1), '#9c7722', label='basline + CNN Adam + backup cont. 3')
plt.xlabel('timesteps (x 4000)')
