...
plt.subplot(1, 1, 1)
plt.plot(np.array(game6_testing_episode_steps_over_training_steps).mean(axis=1), 'b', label='latest 3 pos shared + backup cont.')
...
#plt.plot(np.array(game8_testing_episode_steps_over_training_steps).mean(axis=1), '#7dd147', label='basline + CNN RMS + numeric + backup cont. 2')
#plt.plot(np.array(game9_testing_episode_steps_over_training_steps).mean(axis=1), 'b', label='basline cnn (ids) with backup cont. 2')
plt.plot(np.array(game14_testing_episode_steps_over_training_steps).mean(axis=1), '#7982c9', label='baseline + numeric + backup cont. 3')
plt.plot(np.array(game12_testing_episode_steps_over_training_steps).mean(axis=1), '#9F0FD6', label='baseline + binary + backup cont. 3')
#plt.plot(np.array(game10_testing_episode_steps_over_training_steps).mean(axis=1), '#ff8e2e', label='basline + CNN Adam + numeric + backup cont. 2')
plt.plot(np.array(game13_testing_episode_steps_over_training_steps).mean(axis=1), '#d4177f', label='basline + CNN Adam + numeric + backup cont. 3')
plt.plot(np.array(game11_testing_episode_steps_over_training_steps).mean(axis=1), '#9c7722', label='basline + CNN Adam + binary + backup cont. 3')
